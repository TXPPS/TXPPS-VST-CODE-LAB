  ...
  /* ============ BOSS ============ */
  {
    ...
    stages: [
      ...
      },
      {
        ...
        explain: 'Uncentered, rest reads 8192/8192 = +1.0 → a permanent +2 st bend — the synth is “broken sharp” with a healthy oscillator. Subtract the midpoint and home means home. (14 cents of n8… no: two full semitones. The tuner never lies.)',
      },
      {
        type: 'bugspot', concept: 'performance',
      ...
      },
      {
        ...
        prompt: 'Stage 7 — When the pool is full, stolen voices go SILENT instead of playing their new note. Tap the wrong envelope call.',
        code: [
        ...
        buggy: 5,
        explain: 'reset() drops the envelope to idle and STOPS — isActive() goes false, the render loop skips the voice, and the “new note” is a silent card. The claim must START a life: v.adsr.noteOn(). (A quick pre-fade before the restart is the polish; the attack is the fix.)',
        fix: 'v.adsr.noteOn();',
      },
    ],
  },
