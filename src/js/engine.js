...
const Engine = (() => {
  ...
  function indexAll() {
    const all = [...ZONE1_LESSONS, ...ZONE1_CHALLENGES, ...ZONE2_LESSONS, ...ZONE2_CHALLENGES, ...ZONE3_LESSONS, ...ZONE3_CHALLENGES, ...ZONE4_LESSONS, ...ZONE4_CHALLENGES, ...ZONE5_LESSONS, ...ZONE5_CHALLENGES, ...ZONE6_LESSONS, ...ZONE6_CHALLENGES];
